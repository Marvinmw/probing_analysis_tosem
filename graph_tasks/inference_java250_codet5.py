...
from models.classifier import InferenceCodeT5Model
...
if __name__ == "__main__":
    ...
    tokenizer = RobertaTokenizer.from_pretrained(args.token_config)
    # create dataset
    ...
    #create model
    model = InferenceCodeT5Model(encoder, tokenizer,config, args)
